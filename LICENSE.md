...
*   **"JetBrains"** means JetBrains s.r.o., which has its registered office at Na Hřebenech II 1718/8, Prague, 14000, Czech Republic.
*   **"JetBrains Affiliate"** means the subsidiary and/or any associated companies of JetBrains.
*   **"JetBrains Marketplace"** means any platform operated by JetBrains or a JetBrains Affiliate on which JetBrains or JetBrains Affiliate markets Plugins for JetBrains Products.
...
*   **"Plugin"** means the "Test in" plugin, extension, application, widget, or other software program designed to work with JetBrains Products that the Developer makes available under this EULA.
...
*   **2.3. Duration of License and Transition to Subscription.** The license granted under this EULA is provided as follows:
    *   **Current Free Access:** The Plugin is currently provided as a Free Plugin at no cost to You.
    *   **Future Transition to Paid Model:** The Developer reserves the right, at their sole discretion, to transition the Plugin to a Paid Plugin in the future. If such a transition occurs, continued use of the Plugin or its premium features will require the payment of applicable fees or an active Subscription.

**3. Subscription**

*   **3.1. Subscription Limits.** If You purchased a Plugin Subscription, You must use the Paid Plugin in accordance with the limits described in Your subscription plan.
...
Conversely, You (or the Organization you represent) retain full ownership of all inputted data and work products (such as test cases, text files, and JSON files) that You create through or with the assistance of the Plugin. The Developer claims no ownership rights over your data or scripts.
