 ...
 * <p>
 * The colours read as a traffic light rather than as another priority scale, on
 * purpose: the card already draws the test case's priority and the bug's
 * priority, and those two declare the same red, blue and grey as each other. A
 ...
 * included, and {@code Shared} derives the badge text colour from whichever half
...
public enum BugSeverity {
    /**
     * No severity, because the case did not fail. The colour is never painted:
