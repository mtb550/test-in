...
public enum FileTypes {
    ...
    public void exportToFile(final Project project, final Export export, final File destFile, final Map<String, List<TestCaseDto>> sheetsData) throws Exception {
        handler.handle(project, export, destFile, sheetsData);
    }

    @FunctionalInterface
    public interface ExportHandler {
        void handle(Project project, Export export, File destFile, Map<String, List<TestCaseDto>> sheetsData) throws Exception;
    }
}
