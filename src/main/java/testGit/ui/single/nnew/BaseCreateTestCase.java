...
public class BaseCreateTestCase {
    ...
    public final float BASE_FONT_SIZE = JBUI.Fonts.label().getSize2D();
    public final float TITLE_FONT_SIZE = BASE_FONT_SIZE + 6f;
    public final float FIELD_FONT_SIZE = BASE_FONT_SIZE + 2f;
    ...
    protected final StepsSection stepsSection; // ← إضافة جديدة
    ...
    public BaseCreateTestCase() {
        ...
        this.stepsSection = new StepsSection(); // ← إضافة جديدة
    }

    // unused now
    public ExtendableTextField createTextField(final String placeholder, final Icon icon, final float fontSize) {
    ...
    public void addStepField(final Project project, final JPanel container, final List<TextFieldWithAutoCompletion<String>> stepFields, final String text, final Runnable repackAction, final Set<String> uniqueStepsCache) {
    ...
    public JPanel wrapComponent(final JComponent component, final UpdateField field) {
    ...
    // unused
    public ComboBox<Priority> createPriorityCombo() {
    ...
    // unused
    public JPanel createGroupsPanel() {
    ...
    // unused
    public void addGroups(final JPanel groupsPanel, final List<Groups> groups) {
    ...
    // unused
    public JPanel createReadOnlyField(final String text, final Icon icon, final float fontSize) {
    ...
    public void registerShortcut(final JComponent component, final CustomShortcutSet shortcutSet, final Runnable action) {
        new DumbAwareAction() {
            @Override
