...
public class NavigationBarUI {
    ...
    @NotNull
    public static JComponent create(@Nullable Path currentPath) {
    ...
    @NotNull
    private static List<File> buildPathFileList(@NotNull Path path) {
    ...
    private static void setUnderline(@NotNull JLabel label, boolean underline) {
