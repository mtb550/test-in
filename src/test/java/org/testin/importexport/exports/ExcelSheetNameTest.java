...
public class ExcelSheetNameTest {
    ...
    @Test
    public void aNameExcelAcceptsIsLeftAlone() throws IOException {
     ...
     */
    @Test
    public void aSecondShortSheetOfTheSameNameIsNumbered() throws IOException {
        try (Workbook workbook = new XSSFWorkbook()) {
     ...
     */
    @Test
    public void namesAtTheLimitStillGetDistinctSheets() throws IOException {
     ...
     */
    @Test
    public void twoNamesDifferingOnlyInCaseAreStillTwoSheets() throws IOException {
        try (Workbook workbook = new XSSFWorkbook()) {
     ...
     */
    @Test
    public void theCharactersExcelRefusesAreReplaced() throws IOException {
        try (Workbook workbook = new XSSFWorkbook()) {
