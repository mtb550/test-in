...
| **Numbering**       | Use cases are `UC-CODEGEN-001` to `UC-CODEGEN-021`. Rules are `Rule-CODEGEN-001` to `Rule-CODEGEN-090`                                                                                                                           |
...
| **Difference 1** | `priority` in the generated method carries the position, not the test case's priority. Not a difference: a test method's priority and a test case's priority are different things, and the test case's own writes nothing into the code on purpose. Decided 7 September 2026, [#242](https://github.com/mtb550/test-in/issues/242)                                                                                                                                                                                                                                                                         |
