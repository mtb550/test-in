...
- **Rule 65** — Running needs the TestNG plugin. Without it, the item is
  not offered.
- **Rule 90** — **Run Tests** is offered on **Test Cases**, a test set package,
  a test set and a test run. It is not offered on the test project row, on
