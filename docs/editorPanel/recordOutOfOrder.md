...
- **Rule-EDITOR-PANEL-153** — A verdict can be recorded on any test case at any
  time. The walk does not have to be going.
- **Rule-EDITOR-PANEL-154** — A verdict recorded away from the walk is not
  timed. The test case keeps whatever duration it had.
- **Rule-EDITOR-PANEL-155** — Recording away from the walk does not stop the
