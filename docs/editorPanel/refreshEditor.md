...
- **Rule-EDITOR-PANEL-115** — Refresh clears every filter and the search text.
- **Rule-EDITOR-PANEL-116** — Refresh remembers which test case was selected,
  and lands on the page holding it.
- **Rule-EDITOR-PANEL-117** — The tester's own refresh always reloads, even with
