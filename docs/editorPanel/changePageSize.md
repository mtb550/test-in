...
- **Rule-EDITOR-PANEL-104** — A page holds 50 test cases until the tester says
  otherwise.
- **Rule-EDITOR-PANEL-105** — The most a page can hold is 1000.
- **Rule-EDITOR-PANEL-106** — Changing it goes back to the first page and
