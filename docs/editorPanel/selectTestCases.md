...
- **Rule-EDITOR-PANEL-107** — Several test cases can be selected, in as many
  separate runs as the tester likes.
- **Rule-EDITOR-PANEL-108** — Clicking outside every card clears the selection.
- **Rule-EDITOR-PANEL-109** — Right-clicking outside the selection moves the
  selection to what was clicked first.
- **Rule-EDITOR-PANEL-110** — The grid's selection and the cards' selection are
