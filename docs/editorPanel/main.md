...
2. **A card** — the test case's number in the test set, then its description,
   then a badge for the priority and one for each group.
...
| **Difference 5**  | Two buttons on one toolbar both had the tooltip **Details**. The one that picks what a card shows is **Fields**, which is what this document already called it. Fixed 9 September 2026, [#201](https://github.com/mtb550/test-in/issues/201)                                                                                                                                                                                                                                                                  |
