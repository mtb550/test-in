...
- **Rule-EDITOR-PANEL-135** — A verdict records what it was, who recorded it,
  and when, to the second.
- **Rule-EDITOR-PANEL-136** — A verdict recorded on the test case the walk is
  timing also records how long it took.
- **Rule-EDITOR-PANEL-137** — Recording a pass clears the actual result, the
  error, the bug severity and the bug priority. A test case that passed has
  nothing to explain.
- **Rule-EDITOR-PANEL-138** — The walk then moves to the next test case and
  starts timing it.
- **Rule-EDITOR-PANEL-139** — One test case is one message. Several at once is
...
in Rule-EDITOR-PANEL-137 is only on the keyboard path. A test case failed and
