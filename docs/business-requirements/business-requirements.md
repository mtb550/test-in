[Documentation](../README.md) › Business requirements

# Business Requirement Specification

What Testin promises, and the rules that always hold. No keys here. Keys are
in the [system requirements](../system-requirements/system-requirements.md).
...
[Documentation](../README.md) › **Business requirements** — the other two: [system requirements](../system-requirements/system-requirements.md) · [design](../design/design.md)
