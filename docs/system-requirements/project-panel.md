...
| Key | Does | Scenario |
|---|---|---|
| `Enter` | Opens the selected test set or run | [SR-PP-10](#uc-pp-04--open-a-test-set-or-a-test-run) |
| `Ctrl+M` | Creates a node under the selected one | [SR-PP-12](#uc-pp-05--create-a-test-set-or-a-test-set-package) |
| `Shift+F6` | Renames the selected node | [SR-PP-20](#uc-pp-07--rename-a-node) |
| `Delete` | Removes the selected nodes | [SR-PP-24](#uc-pp-08--remove-a-node) |
| `Ctrl+C` | Copies the selected nodes | [SR-PP-28](#uc-pp-09--move-or-copy-nodes) |
| `Ctrl+X` | Cuts the selected nodes | [SR-PP-29](#uc-pp-09--move-or-copy-nodes) |
| `Ctrl+V` | Pastes into the selected node | [SR-PP-30](#uc-pp-09--move-or-copy-nodes) |
| `Escape` | Clears the gray from cut nodes | [SR-PP-35](#uc-pp-09--move-or-copy-nodes) |
| `Ctrl+Z` | Undoes the last tree change | [SR-PP-39](#uc-pp-11--undo-and-redo-a-change-to-the-tree) |
| `Ctrl+Y` | Redoes it | [SR-PP-40](#uc-pp-11--undo-and-redo-a-change-to-the-tree) |
| `1` `2` `3` | Inside the status popup: Assigned, Completed, Closed | [SR-PP-45](#uc-pp-13--set-a-test-runs-status) |
| `Ctrl+Alt+F` | Opens search, from anywhere in the IDE | [SR-PP-55](#uc-pp-17--find-anything-in-the-project) |
...
> **Then** it opens in its editor, the same as [SR-PP-10](#uc-pp-04--open-a-test-set-or-a-test-run)
...
**SR-PP-A1 · One of five screens, in a fixed order** — BR-PP-14
...
**SR-PP-A2 · One project binds itself** — BR-PP-15
...
**SR-PP-A3 · An archived project is refused with a reason** — BR-PP-53
...
**SR-PP-A5 · A name already used is refused** — BR-PP-04
...
**SR-PP-A6 · By Git address** — BR-PP-18
...
**SR-PP-A7 · Choose from the list** — BR-PP-19
> **Given** the Testin folder is set
...
**SR-PP-A8 · No projects to choose from**
...
**SR-PP-A9 · A binding that cannot be written is not announced** — BR-PP-20
...
**SR-PP-10 · Open with Enter** — BR-PP-21
...
**SR-PP-12 · From the tree** — BR-PP-23
...
**SR-PP-13 · Name it and pick the kind**
...
**SR-PP-14 · A new test set opens and gets its code** — BR-PP-25
...
**SR-PP-17 · Nowhere to create** — BR-PP-24
...
**SR-PP-18 · From the tree** — BR-PP-26
...
**SR-PP-19 · A run is configured before it exists** — BR-PP-27, BR-PP-28
...
**SR-PP-19a · A run needs cases and a name** — BR-PP-27, BR-PP-05
...
**SR-PP-19b · The world moved while the dialog was open**
...
**SR-PP-21 · The code is renamed first** — BR-PP-31
...
**SR-PP-22 · Refusals** — BR-PP-04, BR-PP-05, BR-PP-30
...
**SR-PP-24 · Remove asks first** — BR-PP-06, BR-PP-33
...
**SR-PP-25 · Confirm** — BR-PP-11, BR-PP-34
> **When** the tester presses `Enter`
...
**SR-PP-30 · Paste asks, then moves or copies** — BR-PP-06, BR-PP-40
...
**SR-PP-31 · A copy is a new thing** — BR-PP-41
...
**SR-PP-32 · Refused: wrong place** — BR-PP-37, BR-PP-38, BR-PP-39, BR-PP-13
...
**SR-PP-33 · Refused: name taken** — BR-PP-04
...
**SR-PP-34 · Drag and drop** — BR-PP-40, BR-PP-43
...
> **Then** the **Move** dialog asks the same question as [SR-PP-30](#uc-pp-09--move-or-copy-nodes), and `Enter` moves them
...
**SR-PP-35 · Escape clears the gray**
...
**SR-PP-36 · Only one project** — BR-PP-13
...
**SR-PP-37 · Give a node its number** — BR-PP-44
> **Given** a test set, a package or a test run is selected
...
**SR-PP-38 · The field refuses as you type** — BR-PP-44
...
**SR-PP-39 · Undo** — BR-PP-48, BR-PP-49
...
**SR-PP-43 · A status is one of a fixed few, set from the menu** — BR-PP-54
...
**SR-PP-44 · What retiring does** — BR-PP-08, BR-PP-51, BR-PP-52, BR-PP-53
...
**SR-PP-45 · Pick a status, by key or by row** — BR-PP-56
...
**SR-PP-46 · Completed and Closed sign the run off** — BR-PP-55, BR-PP-09
...
**SR-PP-47 · The next cycle from the last** — BR-PP-57, BR-PP-58, BR-PP-59
...
**SR-PP-48 · The same refusals as creating** — BR-PP-27, BR-PP-05, BR-PP-04
...
**SR-PP-49 · Change its cases, name or configuration** — BR-PP-61
...
**SR-PP-52 · Undoable as one step** — BR-PP-62
...
**SR-PP-53 · Run from a node** — BR-PP-63
...
**SR-PP-54 · Nothing to run** — BR-PP-64, BR-PP-65
...
**SR-PP-55 · Search from anywhere** — BR-PP-66
...
**SR-PP-57 · Refresh** — BR-PP-68, BR-PP-69
...
**SR-PP-60 · The branch box** — BR-PP-71
...
**SR-PP-62 · Uncommitted changes ask first** — BR-PP-72
...
**SR-PP-63 · Details** — BR-PP-74, BR-PP-75
