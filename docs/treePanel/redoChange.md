...
- **Rule-TREE-PANEL-050** — Making a new change forgets everything that was
  undone.

Rule-TREE-PANEL-048 and Rule-TREE-PANEL-049 hold here too. They say what the
...
change is forgotten. (Rule-TREE-PANEL-050)
