...
| **[The editor panel](editorPanel/main.md)** | Writing test cases, and running a test run. Both editors, and [light mode](editorPanel/lightMode.md) | 47 | 221 |
...
| **[Automation code and the gutter](codegen/main.md)** | The test methods Testin writes, and how they are kept in step with the tree | 20 | 75 |
| **[Reports](report/main.md)** | Writing a test run out as a document, in four formats | 3 | 17 |
| **[Sharing work with the team](share/main.md)** | Export, import, Git and a server. Every way test data leaves and arrives | 22 | 110 |
| **[Inside Testin](internal/main.md)** | The parts that belong to no panel: the search, and the one thing that owns every file | 7 | 81 |

**154 use cases and 728 rules**, each one checked against the code it describes.
