...
| **[Automation code and the gutter](codegen/main.md)** | The test methods Testin writes, and how they are kept in step with the tree                          | 21        | 88    |
...
**151 use cases and 772 rules**, each one checked against the code it describes.
