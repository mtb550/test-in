...
| **[Automation code and the gutter](codegen/main.md)** | The test methods Testin writes, and how they are kept in step with the tree | 20 | 76 |
...
**154 use cases and 732 rules**, each one checked against the code it describes.
