...
| **[The editor panel](editorPanel/main.md)**           | Writing test cases, and running a test run. Both editors, and [light mode](editorPanel/lightMode.md) | 48        | 243   |
...
**150 use cases and 762 rules**, each one checked against the code it describes.
