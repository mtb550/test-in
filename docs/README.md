...
| **[The editor panel](editorPanel/main.md)** | Writing test cases, and running a test run. Both editors, and [light mode](editorPanel/lightMode.md) | 47 | 226 |
...
**154 use cases and 743 rules**, each one checked against the code it describes.
