...
|---|---|---|---|
| **[The tree panel](treePanel/main.md)** | The tree on the left. Test projects, test sets, test runs, and everything done to them | 27 | 93 |
...
**152 use cases and 672 rules**, each one checked against the code it describes.
