...
|---|---|---|---|
| **[The tree panel](treePanel/main.md)** | The tree on the left. Test projects, test sets, test runs, and everything done to them | 27 | 98 |
...
**152 use cases and 687 rules**, each one checked against the code it describes.
