...
| **[The view panel](viewPanel/main.md)** | The panel on the right. One test case in full, and what a test run recorded about it | 15 | 63 |
...
**152 use cases and 669 rules**, each one checked against the code it describes.
