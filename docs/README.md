...
| **[Inside Testin](internal/main.md)** | The parts that belong to no panel: the search, and the one thing that owns every file | 7 | 78 |

**152 use cases and 699 rules**, each one checked against the code it describes.
