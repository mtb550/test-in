...
| **[Sharing work with the team](share/main.md)** | Export, import, Git and a server. Every way test data leaves and arrives | 22 | 105 |
| **[Inside Testin](internal/main.md)** | The parts that belong to no panel: the search, and the one thing that owns every file | 7 | 65 |

**152 use cases and 661 rules**, each one checked against the code it describes.
