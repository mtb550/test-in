...
| **[Automation code and the gutter](codegen/main.md)** | The test methods Testin writes, and how they are kept in step with the tree | 20 | 70 |
| **[Reports](report/main.md)** | Writing a test run out as a document, in four formats | 3 | 16 |
| **[Sharing work with the team](share/main.md)** | Export, import, Git and a server. Every way test data leaves and arrives | 22 | 103 |
| **[Inside Testin](internal/main.md)** | The parts that belong to no panel: the search, and the one thing that owns every file | 7 | 65 |

**152 use cases and 658 rules**, each one checked against the code it describes.
