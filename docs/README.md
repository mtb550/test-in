...
| **[Inside Testin](internal/main.md)**                 | The parts that belong to no panel: the search, and the one thing that owns every file                | 8         | 94    |

**151 use cases and 760 rules**, each one checked against the code it describes.
...
| **[Standing decisions](decisions.md)**       | Fourteen designs that look wrong until you know why, and what each one costs to reverse                                                                                     |
...
| **[Standing decisions](decisions.md)**                                          | Fourteen decisions made once, with the reason each one looks wrong, so they are not argued again in every review | Written         |
