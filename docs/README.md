...
| **[The editor panel](editorPanel/main.md)** | Writing test cases, and running a test run. Both editors, and [light mode](editorPanel/lightMode.md) | 48 | 234 |
...
**151 use cases and 746 rules**, each one checked against the code it describes.
