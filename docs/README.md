...
| **[The editor panel](editorPanel/main.md)** | Writing test cases, and running a test run. Both editors, and [light mode](editorPanel/lightMode.md) | 47 | 223 |
...
**154 use cases and 738 rules**, each one checked against the code it describes.
