...
| **[The editor panel](editorPanel/main.md)** | Writing test cases, and executing a test run. Both editors, and [light mode](editorPanel/lightMode.md) | 46 | 191 |
...
**151 use cases and 611 rules**, each one checked against the code it describes.
