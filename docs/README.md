...
| **[Inside Testin](internal/main.md)**                 | The parts that belong to no panel: the search, and the one thing that owns every file                | 7         | 93    |

**150 use cases and 761 rules**, each one checked against the code it describes.
