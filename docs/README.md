...
|---|---|---|---|
| **[The tree panel](treePanel/main.md)** | The tree on the left. Test projects, test sets, test runs, and everything done to them | 27 | 104 |
...
| **[Automation code and the gutter](codegen/main.md)** | The test methods Testin writes, and how they are kept in step with the tree | 20 | 80 |
...
**148 use cases and 730 rules**, each one checked against the code it describes.
